You have the autoresearch skill loaded and are mid-way through executing an autoresearch run (read the skill at skills/autoresearch/SKILL.md in this plugin).
